...
from result2matfrmMDL import Result2Mat
import h5py
...
#     tr_dataloader = DataLoader(train_patches, batch_size=256, shuffle=True, num_workers=0)
    ...
    epochs = 100
    model_name = 'august'
    checkpoint_dir = '/DATA1/user/Documents/Paper Aug 2022/data/BGU/checkpoints/'
    model_path = os.path.join(checkpoint_dir, ''.join([model_name, '-{:3d}-{:3d}-{:2d}-{:2d}.pth']))
